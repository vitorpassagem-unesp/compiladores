...
| 1 | modificar a função match para que, em caso de erro, acuse o número da linha e a coluna; | Gustavo | Sim |
| 2 | a mensagem de erro de sintaxe, ainda no match, deve ser reportando o que era esperado e o que foi encontrado; | Gustavo | Sim |
| 3 | não é para imprimir o número associado ao token e sim o nome do mesmo, à exceção dos códigos ASCII, como ';' '.' etc; | Gustavo | Sim |
| 4 | ainda no tratamento de erro no match, resolver o problema do exit para não quebrar a execução do ineterpretador de comando; | Vitor F. | Sim |
